...
def transparencia(request):
    relatorios = RelatorioAnual.objects.all().order_by('-ano')  # pega todos, do mais recente pro mais antigo
    return render(request, "app/transparencia.html", {
        "idBody": "transparencia",
